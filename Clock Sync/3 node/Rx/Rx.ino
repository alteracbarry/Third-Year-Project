/* Ultrasonic Range Finder (3+ nodes) - Receiver slave
 
 */

unsigned long serial_time = 0; // holds latest serial event time
unsigned long sensor_time = 0; // holds latest sensor event time
int identifier = 'R'; // an ID assigned to nodes
int mode = 0; // 0: no event; R [ID]: sync request & serial_time; z: request sensor_time
